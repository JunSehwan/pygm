    ...
    () => [
      {
        ...
        image: "/image/welcome/step1_profile.png",
      },
      {
        step: 2,
        title: "STEP 1. 프로필 작성",
      ...
      },
      {
        ...
        image: "/image/welcome/step2_send.png",
      },
      {
        step: 5,
        title: "STEP 3. 남성에게 안내",
        body: "",
        description:
          "여성이 Pick하면, 남성분에게 안내드립니다.\n따라서, 다른 소개앱처럼 무의미한 이성추천이\n아니라 실제 관심 기반 요청만 전달돼요.",
        image: "/image/welcome/step3_calling.png",
      },
      {
        step: 6,
        ...
        image: "/image/welcome/step4_date.png",
      },
    ],
    []
  );
        ...
        <AnimatePresence mode="wait" custom={direction}>
          ...
          >
            <WelcomeSlideCard
              ...
              total={slides.length}
              onClickExploreCards={() => openConfirmForRoute("/cards")}
              onClickTests={() => openConfirmForRoute("/tests")}
              onPrev={goPrev}
              onNext={goNext}
