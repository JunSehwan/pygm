...
const Modal = ({ onClose, title, visible, widths, subtitle, onBuy }) => {
          ...
          <ModalSection className="fixed mt-8 top-[30%] overflow-y-hidden rounded-lg w-full max-w-[420px]"
            ...
            <div className='relative w-full'>
              <div className='w-full flex items-end p-3'>
                <button
                  className="p-3 rounded-xl hover:bg-pink-200 ml-auto bg-transparent border-0 text-gray-500 hover:text-gray-700 float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
                  onClick={onClose}
                >
                ...
                <div className="flex flex-col items-start justify-between p-2 rounded-t">
                  ...
                  <div className="relative rounded border w-full">
                    ...
                    <h2 className="text-gray-500 text-md p-3 font-normal tracking-normal leading-tight w-full text-center">
                      호감있는 이성과의 매칭을 위해서는<br />
                      윙크를 구매해야 합니다.
                      <br />
                      <span className='font-semibold text-slate-600'>그럼, 윙크 가격을 둘러보러 가보실까요?</span></h2>
                  </div>
