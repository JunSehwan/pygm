...
const CoupleCard = ({ friend, sido, sigugunList }) => {
  ...
  return (
    ...
    >
      <section className='w-full relative'>
        ...
        {/* <span className='absolute top-2 right-2 rounded-full px-3 py-1 bg-gray-800/50 text-md font-bold text-white'>D-7일</span> */}
      </section>
