      ...
      <div className="px-4 mx-auto max-w-screen-xl text-center py-32">
        ...
        <div className="flex flex-col justify-center sm:flex-row sm:space-y-0 w-full">
          <button
            ...
            className="w-[50%] mx-auto inline-flex justify-center items-center py-4 text-base font-medium text-center text-white rounded-lg bg-violet-500 hover:bg-opacity-70 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
            시작하기
